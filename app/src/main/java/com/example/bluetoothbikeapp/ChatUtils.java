...
public class ChatUtils {
    ...
    public synchronized void setState(int state) {
        this.state = state;
        handler.obtainMessage(BluetoothDeviceActivity.MESSAGE_STATE_CHANGED, state, -1).sendToTarget();
    }
    ...
    private void connectionLost() {
        Message message = handler.obtainMessage(BluetoothDeviceActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothDeviceActivity.TOAST, "Connection Lost");
    ...
    private synchronized void connectionFailed() {
        Message message = handler.obtainMessage(BluetoothDeviceActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothDeviceActivity.TOAST, "Cant connect to the device");
        message.setData(bundle);
        handler.sendMessage(message);
    ...
    private synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message message = handler.obtainMessage(BluetoothDeviceActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothDeviceActivity.DEVICE_NAME, device.getName());
        message.setData(bundle);
        handler.sendMessage(message);
